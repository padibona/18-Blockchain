...
# YOUR CODE HERE
sender_data = st.text_area('Sending from')
# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
# YOUR CODE HERE
receiver_data = st.text_area('Recipient')
# @TODO:
# Add an input area where you can get a value for `amount` from the user.
# YOUR CODE HERE
amount_sent_data = st.text_area('Amount being sent')
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        record = Record(sender_data, receiver_data, amount_sent_data),
        creator_id=42,
